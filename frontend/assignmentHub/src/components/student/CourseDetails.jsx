...
const CourseDetails = () => {
  ...
  useEffect(() => {
    const fetchingCourseById = async () => {
      try {
        setLoading(true);
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 text-center">
        ...
        <p className="max-w-md text-gray-400">
          We could not load this course. It may not exist, or you may not be
          enrolled in it.
        </p>
        <Link
        ...
        <div className="flex flex-col gap-7 p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid w-full grid-cols-2 gap-3 sm:w-auto">
            <div className="rounded-2xl bg-white/5 p-4">
              ...
              <p className="mt-1 font-semibold text-white">{data.lecturer}</p>
            </div>
            <div className="rounded-2xl bg-white/5 p-4">
        ...
        {assignments.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-white/15 bg-white/[0.03] px-6 py-16 text-center">
            ...
            <p className="mt-2 text-gray-400">
              New assignments for this course will appear here.
            </p>
          </div>
        ) : (
          <motion.div
